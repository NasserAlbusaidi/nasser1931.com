...
Reproduction artifacts: `paper/data/cache/hrv_daily_alltime.json` (1,150 days of Garmin HRV, Feb 2023 → Apr 2026), `paper/data/cache/daily_calories_alltime.json` (1,268 days of MF calories, Oct 2022 → Apr 2026), `paper/data/hrv_calories_daily_alltime.json` (1,113 era-tagged consecutive-day pairs), `paper/scripts/pull_hrv_bulk.py` (idempotent direct-API pull), `paper/scripts/section7_v2_facts.py` (per-era stats source).
